...
stat_list <- list(stat_flk, stat_bsu)
chg_list <- list(chg_bsu, chg_flk)

df_key_join <- EtE_changes(df_status = stat_list, df_change = chg_list, from = 1999 , to = 2018, jointly = TRUE)
